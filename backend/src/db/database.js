...
/**
 * Update job status and optionally source_plan, quote, tx_hashes, error.
 */
...
/**
 * Update only the tx_hashes for a specific step (merges with existing).
 */
...
/**
 * Retrieve a payment job by id. Auto-parses JSON fields.
 */
...
/**
 * Get paginated completed payments for a merchant.
 */
...
/**
 * Get paginated payments (all statuses) for a merchant.
 */
...
/**
 * Mark AWAITING_CONFIRMATION jobs past their expires_at as EXPIRED.
